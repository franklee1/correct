...
class CMainParams : public CChainParams
{
  public:
    CMainParams()
    {
        ...
        const char *pszTimestamp = "The final score of Feb 2018";
   ...
   //      printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
     //    printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0xa9e6ee349d8e5925cdd4927c50cd5d4a7a68cf239fb57e48d77d1eadbdbf9adc"));
        assert(genesis.hashMerkleRoot == uint256("0xacf55b509b8b1ab2e588fcb965adc5b3effb790c8431fd1f9d1bb02696db95c5"));
